...
<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-button class="addClassBtn" type="primary" @click="getParentCateList">添加分类</el-button>
    </el-breadcrumb>
    <el-card>
...
-->
      ...
      <treeTable :data="cateList" :selection-type="false" :expand-type="false" show-index index-text="" border :columns="columns">
        ...
        <template slot="operate" slot-scope="scope">
          <el-button size="mini" type="primary" icon="el-icon-edit" @click="showUpdateCate(scope.row.cat_id)">编辑</el-button>
          <el-button size="mini" type="danger" icon="el-icon-delete" @click="showDeleteCate(scope.row.cat_id)">删除</el-button>
        </template>
      </treeTable>
      <el-pagination
    ...
    <!-- 添加分类对话框 -->
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="30%" :before-close="addCateDialogClose">
      <el-form :model="addCateFrom" :rules="addCateFromRules" ref="addCateRef" label-width="100px">
        <el-form-item label="分类名称：" prop="cat_name">
          <el-input v-model="addCateFrom.cat_name"></el-input>
        </el-form-item>
        <el-form-item label="父级分类：">
          <el-cascader v-model="selectedKeys" :options="parentCateList" style="width: 100%;" :props="cascaderProps" @change="parentCateChange" clearable></el-cascader>
        </el-form-item>
      </el-form>
    ...
    <!-- 编辑分类对话框 -->
    <el-dialog title="编辑" :visible.sync="updateCateDialogVisible" width="30%" :before-close="updateCateDialogClose">
      <el-form :model="updateCateFrom" :rules="addCateFromRules" ref="updateCateRef" label-width="100px">
        <el-form-item label="分类名称：" prop="cat_name">
